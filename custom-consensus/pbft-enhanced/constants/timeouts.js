 ...
 *   - TRANSACTION_INACTIVITY_THRESHOLD_MS: 3000 (was 8000)
 ...
 *   - RATE_BROADCAST_INTERVAL_MS: 8000 (was 15000)
 *       Core monitors 6 shards. Faster health polling (every 8 s) means
 *       a dead shard (≥2 faulty nodes) is detected by the core sooner, cutting
 *       the first leg of the redirect rescue pipeline from up to 15 s to 8 s.
 *
 ...
 *   New: 5 + 8 + 10 = 23 s  ← DRAIN_INTERVAL_MS is set in appP2p.js
 */
module.exports = {
  BLOCK_CREATION_TIMEOUT_MS: 5000,
  TRANSACTION_INACTIVITY_THRESHOLD_MS: 3000,
  TRANSACTION_REASSIGNMENT_TIMEOUT_MS: 30000,
  RATE_BROADCAST_INTERVAL_MS: 8000,
