...
CPU_LIMIT=0.1
NUMBER_OF_NODES=$NUMBER_OF_NODES TRANSACTION_THRESHOLD=$TRANSACTION_THRESHOLD NUMBER_OF_FAULTY_NODES=$NUMBER_OF_FAULTY_NODES NUMBER_OF_NODES_PER_SHARD=$NUMBER_OF_NODES_PER_SHARD SHOULD_REDIRECT_FROM_FAULTY_NODES=$SHOULD_REDIRECT_FROM_FAULTY_NODES CPU_LIMIT=$CPU_LIMIT node prepare-config.js
